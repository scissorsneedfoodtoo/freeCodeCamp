...
Add a `style` attribute to the paragraph element and use string interpolation to set the value to `margin-top: ${currMargin}px;`, where `currMargin` is the `margin` property of the current object.
