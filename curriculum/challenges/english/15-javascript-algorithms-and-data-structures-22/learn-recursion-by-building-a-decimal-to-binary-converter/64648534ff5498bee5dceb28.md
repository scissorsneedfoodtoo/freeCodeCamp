...
Next, add an object with to the `animationData` array. The object should have three properties: `inputVal`, `margin`, and `addElDelay`. The `inputVal` property should be set to `5`, `margin` should be set to `200`, and `addElDelay` should be set to `1000`.
