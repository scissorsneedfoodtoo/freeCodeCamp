...
Then, use the compound assignment operator (`+=`) to set the `innerHTML` property of the `showAnimationDiv` to an empty template literal string. As a reminder, template literal strings start and end with backticks (``).
