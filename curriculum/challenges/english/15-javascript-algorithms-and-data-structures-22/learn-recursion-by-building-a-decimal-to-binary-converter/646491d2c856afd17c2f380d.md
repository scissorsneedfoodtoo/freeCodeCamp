...
Within the callback function, add a `setTimeout()` function. As the first parameter, pass in an empty callback function. And as the second parameter, pass in `obj.addElDelay`.
