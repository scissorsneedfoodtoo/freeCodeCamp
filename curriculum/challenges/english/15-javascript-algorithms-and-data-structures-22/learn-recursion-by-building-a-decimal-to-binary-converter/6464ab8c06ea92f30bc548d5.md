...
For the last animation object, add the property `msg` set to the string `decimalToBinary(5) returns "10" + 1 (5 % 2). Then it pops off the stack.`. Also, add the property `showMsgDelay` set to `15000` and the property `removeElDelay` set to `20000`.
