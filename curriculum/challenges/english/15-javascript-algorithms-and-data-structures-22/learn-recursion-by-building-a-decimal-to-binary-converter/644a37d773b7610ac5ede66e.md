...
Now that you're familiar with binary numbers, it's time to build the function to do the actual decimal to binary conversion for you. You'll start off with a simpler solution first, then refactor that into a recursive solution.
